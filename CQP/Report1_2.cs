...
namespace CQP
{
    public partial class Report1_2 : Form
    {
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text != " ")
            {
                try
                {
                    ModuleReport1_2 Mta = new ModuleReport1_2();

                    Mta.SetParameterValue("rem", Edit_etat_avc.s);
                    Mta.SetParameterValue("remarque", Edit_etat_avc.r);
